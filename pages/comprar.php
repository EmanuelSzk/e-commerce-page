...
<head>
    ...
    <link rel="stylesheet" href="../Styles/Style.css?v=8.1s"> <!-- el "?v=1.1" es para que al entrar por xampp a la página en php se actualice el style.css y no se use el style.css guardado en la caché de la página y así visualizar los cambios al recargar -->
